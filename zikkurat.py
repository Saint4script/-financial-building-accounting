...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.calendarWidget.setGeometry(QtCore.QRect(500, 150, 471, 261))
        ...
        self.label_10.setGeometry(QtCore.QRect(560, 110, 301, 21))
        font = QtGui.QFont()
        font.setPointSize(10)
        self.label_10.setFont(font)
        self.label_10.setObjectName("label_10")
        self.label_11 = QtWidgets.QLabel(self.centralwidget)
        self.label_11.setGeometry(QtCore.QRect(80, 380, 741, 31))
        font = QtGui.QFont()
        font.setPointSize(10)
...
#Начальная цена 1 м^2(руб)
    def retranslateUi(self, MainWindow):
        ...
        self.label_11.setText(_translate("MainWindow", "Ввод процентов потребности в денежных средствах по производственной необходимости"))
